...
ttk.Button(window,text='Generate',command=generate).grid(row=0,column=2,pady=10,padx=5)
ttk.Entry(window,textvariable=password).grid(column=3,row=0,pady=10)
